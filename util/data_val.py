...
def get_loader(image_root, gt_root, edge_root, batchsize, trainsize, shuffle=True, num_workers=0, pin_memory=False):
...
def create_dataloader(image_root, gt_root, testsize,rank):
    # 创建 Dataset 实例
    ...
    # 创建 DataLoader，结合 DistributedSampler
    dataloader = DataLoader(
        dataset,

        shuffle=False,  # 使用 DistributedSampler 时不需要再 shuffle
